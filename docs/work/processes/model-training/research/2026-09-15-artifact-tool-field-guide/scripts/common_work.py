...
def render(payload, *, body, context):
    ...
    html='<div class="af-guide af-common" id="af-common"><p>Loading the saved practical examples. These controls do not execute workbook edits.</p><noscript>Enable JavaScript to explore the examples; the surrounding explanation and source links remain readable.</noscript></div>'
