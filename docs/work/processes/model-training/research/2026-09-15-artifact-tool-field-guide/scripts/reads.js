...
function mount(root,{tree}){
 ...
 function draw(){
  ...
  root.innerHTML='<div class="rx-heading"><div class="af-kicker">Reading choices</div><h4>Choose the cells. Choose what comes back.</h4><p>A value is what a cell contains now. A formula is the rule that calculates it. You can read either one, or have your code put them together.</p></div>'+
